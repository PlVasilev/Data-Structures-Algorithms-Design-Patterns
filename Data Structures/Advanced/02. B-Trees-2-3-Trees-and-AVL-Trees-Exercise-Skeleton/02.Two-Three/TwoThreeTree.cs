namespace _02.Two_Three
{
    ...
    public class TwoThreeTree<T> where T : IComparable<T>
    {
        ...
        private TreeNode<T> Merge(TreeNode<T> current, TreeNode<T> newNode)
        {
            if (current.RightKey == null)
            {
                if (current.LeftKey.CompareTo(newNode.LeftKey) < 0)
                {
                    current.RightKey = newNode.LeftKey;
                ...
                else
                {
                    ...
                    current.LeftKey = newNode.LeftKey;
                    current.MiddleChild = newNode.MiddleChild;
                }
                return current;
            }
            else if (current.LeftKey.CompareTo(newNode.LeftKey) >= 0)
            {
            ...
            else if (current.RightKey.CompareTo(newNode.LeftKey) >= 0)
            {
                newNode.MiddleChild = new TreeNode<T>(current.RightKey)
                {
