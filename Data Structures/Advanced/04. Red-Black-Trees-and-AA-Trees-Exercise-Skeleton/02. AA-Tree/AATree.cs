namespace _02._AA_Tree
{
        ...
        where T : IComparable<T>
    {
        ...
        private int Level(Node<T> node) // => node?.Level ?? 0;
        {
        ...
        public void InOrder(Action<T> action) => VisitInOrder(this.root, action);
        ...
        public void PreOrder(Action<T> action) => VisitPreOrder(this.root, action);
        ...
        public void PostOrder(Action<T> action) => VisitPostOrder(this.root, action);
